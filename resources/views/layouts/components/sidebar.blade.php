    ...
    <div class="sidebar-wrapper active">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo d-flex justify-content-start align-items-center">
                    <a href="{{ url('.') }}" class="d-flex align-items-center">
                        <img src="{{ url('assets/img/EVZ-LOGO-AK-XS.png') }}" alt="Dashboard Brand Images" style="width: 28px; height: fit-content">
                        <span class="ms-2 fs-4">EVZ</span>
                    </a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ $activeMenu == 'services' ? 'active' : '' }}">
                    <a href="{{ url('user/services') }}" class='sidebar-link'>
                ...
                <li class="sidebar-item {{ $activeMenu == 'tickets' ? 'active' : '' }}">
                    <a href="{{ url('user/tickets') }}" class='sidebar-link'>
